 ...
 */
public class CartesianTestModeler implements Runnable {
    ...
    public CartesianTestModeler(String windowTitle, int width, int height, boolean vsSync, ILogic logic) {
    ...
    public static void main(String[] args){
        try {
            ...
            ILogic envLogic = new CartesianLogic();
            CartesianTestModeler engine = new CartesianTestModeler("3D Modeler", 800, 600, true, envLogic);
            engine.start();
