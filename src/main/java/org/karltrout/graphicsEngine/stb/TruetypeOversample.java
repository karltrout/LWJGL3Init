 ...
 */
package org.karltrout.graphicsEngine.stb;
...
import static org.karltrout.graphicsEngine.GLFWUtil.glfwInvoke;
...
public final class TruetypeOversample {
    ...
    private void load_fonts() {
        ...
        try (STBTTPackContext pc = STBTTPackContext.malloc()) {
            ByteBuffer ttf = ioResourceToByteBuffer("resources/fonts/FiraSans.ttf", 160 * 1024);
